...
const Flights = {
    ...
    create(body) {
        return request("POST", "/flights", body);
    },

    update(id, body) {
        return request("PUT", `/flights/${id}`, body);
    },
...
const Reservations = {
    ...
    create(body) {
        return request("POST", "/reservations", body);
    },

    cancel(id) {
        return request("PUT", `/reservations/cancel/${id}`);
    }
};
...
const Passengers = {
    ...
    create(body) {
        return request("POST", "/passengers", body);
    },

    update(id, body) {
        return request("PUT", `/passengers/${id}`, body);
    },
...
const Airlines = {
    getAll() {
        return request("GET", "/airlines");
    },

    create(body) {
        return request("POST", "/airlines", body);
    },

    update(id, body) {
        return request("PUT", `/airlines/${id}`, body);
    },

    delete(id) {
        return request("DELETE", `/airlines/${id}`);
    }
};
...
const Claims = {
    ...
    create(body) {
        return request("POST", "/claims", body);
    },

    getByEmail(email) {
        return request("GET", `/claims/by-email?email=${email}`);
    },

    updateStatus(id, status) {
        return request("PUT", `/claims/${id}/status?status=${status}`);
    }
};
